...
@NgModule({
  declarations: [
    ...
    ShareDialogComponent, ShareUiComponent, StylesDialogComponent, EditStyleDialogComponent, NewStyleDialogComponent, WorkflowsDialogComponent, EditWorkflowDialogComponent
  ],
  imports: [
    AppRoutingModule,
    BrowserModule,
